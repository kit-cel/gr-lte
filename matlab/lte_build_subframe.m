function[out]=lte_build_subframe(N_id,fftl,N_rb_dl,subfr_num,pbch,sss,pss,N_ant)
...
if N_ant==1 % specify antenna port
    p=0;
else
    p=1;
end
...
if subfr_num==0
    %disp('lte_build_subframe-->Map PBCH');
    %disp(size(pbch));
    pbch0=pbch(1:48,:);
