function[mib sfn N_ant]=lte_pbch_decode(pbch_frame,pbch_ce,N_id,N_ant_as)
% function demodulates QPSK, descrambles and calls lte_bch_decode

style='tx_diversity';
disp(['lte_pbch_decode: ' num2str(size(pbch_frame)) ', assumed antenna ports: ' num2str(N_ant_as)]);
...
pbch_layer_demap=lte_pre_decoder(pbch_frame,pbch_ce,N_ant_as,style);
