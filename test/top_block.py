...
# Title: Top Block
# Generated: Thu Jul 24 02:43:27 2014
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_vector_to_stream_0_0_1_0 = blocks.vector_to_stream(gr.sizeof_gr_complex*1, 480)
        self.blocks_vector_to_stream_0_0_1 = blocks.vector_to_stream(gr.sizeof_gr_complex*1, 240)
        ...
        self.connect((self.blocks_vector_to_stream_0_0_1, 0), (self.qtgui_const_sink_x_0_0_1, 0))
        self.connect((self.blocks_vector_to_stream_0_0_1_0, 0), (self.qtgui_const_sink_x_0_0_1_0, 0))
        self.connect((self.lte_mimo_pbch_demux_0_0, 0), (self.blocks_vector_to_stream_0_0_1_0, 0))
        self.connect((self.lte_mimo_pre_decoder_0_0, 0), (self.blocks_vector_to_stream_0_0_1, 0))
